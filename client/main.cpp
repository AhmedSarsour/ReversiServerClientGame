...
int main() {
    ...
    cout << "Hi Welcome to Reversi please select your kind of game to play:"
         << endl;
    cout << endl;
    ...
    if (option == 3) {
        ...
        while (1) {
            ...
            if (!(strcmp(s2.c_str(), "list_games") == 0
                  || strcmp(s2.c_str(), "start") == 0
                  || strcmp(s2.c_str(), "join") == 0
    ...
    if (option == 1 || option == 2 || option == 3) {
        ...
        //	//creating the board.
        Board *theGameBoard = new ConsoleBoard(row, col, firstPlayer,
                                               secondPlayer);
